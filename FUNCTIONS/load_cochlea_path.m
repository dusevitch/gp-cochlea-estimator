% Getting a 
function [R_cochlea, point_pos, point_field] = load_cochlea_path(head_side);
...
%     quiver3(final_points_R(:,1),final_points_R(:,2),final_points_R(:,3),b_vectors_R(:,1),b_vectors_R(:,2),b_vectors_R(:,3),'k');
    ...
    if head_side==0
        R_cochlea = left_path_transf_matrix;
        point_pos = final_points;
        point_field = b_vectors;
    else
        R_cochlea = right_path_transf_matrix;
        point_pos = final_points_R;
        point_field = b_vectors_R;
    end
end